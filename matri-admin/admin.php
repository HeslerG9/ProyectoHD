		...
		<div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    En esta sección se podrá registrar a los usuarios con atributos de adminstradores
                </div>
            </div>
		</div>
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
						   ...
						   <div class="group-material">
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Nombres del administrador" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Nombres del administrador">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombres</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Apellidos del administrador" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{5,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Apellidos del administrador">
                                <span class="highlight"></span>
                                <span class="bar"></span>
							...
							<div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Nombre o numero de administrador" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,20}" maxlength="20" required="required" data-toggle="tooltip" data-placement="top" title="Solamente 11 números">
                                <span class="highlight"></span>
                                <span class="bar"></span>
								<label>Número de administrador o nombre</label>
							</div>
							<div class="group-material">
