                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
						   ...
						   <!--
							<div class="group-material">
								<span>Codigo persona</span>
								<select class="material-control tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el codigo del alumno">
									<option value="" disabled="" selected="">Seleccionar codigo persona</option>
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Nombres del alumno" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Nombres del estudiante">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombres</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Apellidos del alumno" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{5,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Apellidos del estudiante">
                                <span class="highlight"></span>
                                <span class="bar"></span>
							...
							<div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Número de cuenta" pattern="^[2]\d{10,10}$" required="required" maxlength="11" data-toggle="tooltip" data-placement="top" title="Solamente 11 números">
                                <span class="highlight"></span>
                                <span class="bar"></span>
